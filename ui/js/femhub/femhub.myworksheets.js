...
FEMhub.MyWorksheets = Ext.extend(FEMhub.Window, {
    grid: null,
    ...
    constructor: function(config) {
        ...
        FEMhub.MyWorksheets.superclass.constructor.call(this, config);
    },
    ...
    fillGrid: function() {
        ...
        FEMhub.RPC.Core.getMyWorksheets({}, {
...
Ext.reg('x-femhub-myworksheets', FEMhub.MyWorksheets);
